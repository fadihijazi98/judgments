    ...
    <div class="frame">
        <div class="nav">
            <ul class="links">
                ...
                <li class="signup-inactive"><a class="btn">Form</a></li>
            </ul>
        </div>
        ...
        <form class="form-signup" action="/conn.php" method="post" name="form">
            <label for="fullname">Full name</label>
            <input class="form-styling" type="text" name="fullname" placeholder="fullname"/>
            <label for="email">Email</label>
            <input class="form-styling" type="email" name="email" placeholder="email"/>
            <label for="password">Number</label>
            <input class="form-styling" type="text" name="number" placeholder="Number"/>
            <label for="confirmpassword">Avarege</label>
            <input class="form-styling" type="text" name="gcd" placeholder="Avarege"/>
            <a ng-click="checked = !checked" class="btn-signup">Done</a>
        </form>
